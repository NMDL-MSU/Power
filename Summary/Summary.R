...
#' ### Plot Power  
#+ power_equal, fig.align='center', fig.width=7, fig.height=7, dpi=600, echo=FALSE
...
#+ power_unequal, fig.align='center', fig.width=7, fig.height=7, dpi=600, echo=FALSE
...
htmlRunR
Summary.R nodes=1,cpus-per-task=1,time=00:20:00,mem=10G +Power Table
